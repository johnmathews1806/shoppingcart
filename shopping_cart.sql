...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "HIBERNATE_SEQUENCE"  MINVALUE 1 MAXVALUE 9999999999 INCREMENT BY 1 START WITH 201 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
Insert into CONTACT_DETAILS (CONTACT_ID,USER_ID,ADDRESS_1,ADDRESS_2,CITY,STATE,COUNTRY,EMAIL_ID,PHONE,MOBILE,CREATE_DATE,CREATE_USER,UPDATE_DATE,UPDATE_USER) values (193,192,'skdlfj','sdlkfj','sdfsdf','sdfs','sdfq','jm.john@gmail.com','sdf','sdfjk',null,null,null,null);
Insert into CONTACT_DETAILS (CONTACT_ID,USER_ID,ADDRESS_1,ADDRESS_2,CITY,STATE,COUNTRY,EMAIL_ID,PHONE,MOBILE,CREATE_DATE,CREATE_USER,UPDATE_DATE,UPDATE_USER) values (195,194,'sdf','sdf','sdf','sdfjl','sdfj','dodo','sdfj','sdf',null,null,null,null);
