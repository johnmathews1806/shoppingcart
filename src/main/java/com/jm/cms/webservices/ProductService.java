 ...
 * 
 */
@WebServiceClient(name = "ProductService", targetNamespace = "http://webservices.cms.jm.com/", wsdlLocation = "http://localhost:7001/cmsadministrator/product?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PRODUCTSERVICE_QNAME = new QName("http://webservices.cms.jm.com/", "ProductService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:7001/cmsadministrator/product?wsdl");
    ...
    public Product getProductPort() {
        return super.getPort(new QName("http://webservices.cms.jm.com/", "ProductPort"), Product.class);
    }
    ...
    public Product getProductPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservices.cms.jm.com/", "ProductPort"), Product.class, features);
    }
