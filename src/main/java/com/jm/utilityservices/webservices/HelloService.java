 ...
 * 
 */
@WebServiceClient(name = "HelloService", targetNamespace = "http://webservices.utilityservices.jm.com/", wsdlLocation = "http://localhost:7001/utilityservices/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICE_QNAME = new QName("http://webservices.utilityservices.jm.com/", "HelloService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:7001/utilityservices/hello?wsdl");
    ...
    public Hello getHelloPort() {
        return super.getPort(new QName("http://webservices.utilityservices.jm.com/", "HelloPort"), Hello.class);                
    }
    ...
    public Hello getHelloPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservices.utilityservices.jm.com/", "HelloPort"), Hello.class, features);
    }
